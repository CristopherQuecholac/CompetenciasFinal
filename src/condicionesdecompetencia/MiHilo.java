...
public class MiHilo extends Thread{
    ...
    private int op;
    public MiHilo(JTextArea area, RecursoCompartido rc, Cerradura vc, Cerradura vc2, Lock mutex, Interrupcion inter, Dekker dk, int op){
        this.area=area;
        this.rc = rc;
        this.vc = vc;
        this.vc2 = vc2;
        ...
        while(true){
            ...
            switch(op){
                ...
                case 1: if(!vc2.isVCerradura()){
                        ...
                        rc.setRc(rc.getRc()+1);
                        area.append("Soy hilo 1 :"+rc.getRc()+"\n");
