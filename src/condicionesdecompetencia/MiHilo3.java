...
public class MiHilo3 extends Thread{
    ...
    private Cerradura vc;
    private RecursoCompartido rc;
    private Cerradura vc2;
    private Lock mutex;
    private boolean pausa=false, vivo=true;
    private Interrupcion inter;
    private Dekker dk;
    private int op;
    public MiHilo3(JTextArea area, RecursoCompartido rc, Cerradura vc, Cerradura vc2, Lock mutex, Interrupcion inter, Dekker dk, int op){
        this.area=area;
        this.rc = rc;
        this.vc = vc;
        this.vc2=vc2;
        ...
        while(true){
            ...
            switch(op){
                ...
                case 1: if(!vc2.isVCerradura()){
                        ...
                        rc.setRc(rc.getRc()+1);
                        area.append("Soy hilo 3 :"+rc.getRc()+"\n");
